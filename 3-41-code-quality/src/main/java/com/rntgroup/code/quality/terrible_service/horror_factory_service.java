package com.rntgroup.code.quality.terrible_service;

import com.rntgroup.code.quality.terrible_domain.horror;
import com.rntgroup.code.quality.terrible_domain.horror_creature;
import com.rntgroup.code.quality.terrible_domain.horrortype;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.Random;

public class horror_factory_service {
    ...
    public class horror_factory_creature extends horror_creature implements Serializable, Cloneable {
        ...
        public boolean equals(Object obj) {
            return ((horror_factory_creature) obj).equals(this);
        }
